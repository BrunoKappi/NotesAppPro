...
import { MaxLengthEmail } from '../../GlobalVars';
        ...
        <div className='DivRegisterForm'>
            ...
            <img className="LogoLogin" src={Logo} alt="" />
                ...
                <form onSubmit={HandleSubmitSigin} className="RegisterForm">
                    ...
                    <input maxLength={MaxLengthEmail} className='ForgetInput' type="email" placeholder='Email' onChange={e => setEmail(e.target.value)} />
